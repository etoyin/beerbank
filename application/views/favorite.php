          ...
          $.ajax({
            ...
            success: function (d) {
              ...
              for (var i = 0; i < d.length; i++) {
                $('.flex-container-2').append("<div class='nopad'><label class='image-checkbox'><span class='star glyphicon glyphicon-star'></span><input type='checkbox' name='image_check[]' checked value="+ d[i].id +" /></label><img alt='"+d[i].name+"' id='beer-img' class='img-responsive' src='"+d[i].image_url+"'/><h5 style='font-size:1.4em;>"+d[i].name+"</h5><h6 style='font-size:1.1em;>"+d[i].tagline+"</h6></div>");
